          ...
          >
            <div className="containerct back-top">
              ...
              <h3 className="midT marg-t1">
                Start your career in tech, by taking our courses that are
                tailored to be comprehensive, and flexible to make you more
                valuable to employers and the society at large.
              </h3>
          ...
          <div className="grid-type">
            <div>
              ...
              <div className="bgc-white padder">
                ...
                sapien eros, sollicitudin a diam in, tristique tempor nulla.
              </div>
            </div>
            <div>
              <div
